...
#     jobTitle2 = input("Please enter your first past job: ").title()
#     jobEmployer2 = input("Please enter your first past job employer: ").title()
#     startingDate2 = input("Date started: ")
#     endingDate2 = input("Date ended: ")
#     location2 = input("Location: ").title()
#     description2 = input("Enter description: ").title()

#     jobTitle3 = input("Please enter your first past job: ").title()
#     jobEmployer3 = input("Please enter your first past job employer: ").title()
#     startingDate3 = input("Date started: ")
#     endingDate3 = input("Date ended: ")
...
def create_profile():
    ...
    # connect.execute("SELECT * FROM profile WHERE firstname_db = 'Sean' ")
...
def display_profile(first_name):
    ...
    # get = connect.execute("SELECT * FROM profile WHERE firstname_db = %s")

    # my_cursor = conn.execute(get, first_name)
    ...
    # sql = 'SELECT * FROM profile WHERE firstname_db = ' + first_name 
    

    # connect.execute(sql)

    # myresult = connect.fetchall()
